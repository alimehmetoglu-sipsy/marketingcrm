...
interface InvestorDynamicFieldProps {
  field: InvestorCustomField
  value: any
  onChange: (value: any) => void
}

export function InvestorDynamicField({ field, value, onChange }: InvestorDynamicFieldProps) {
  const [open, setOpen] = useState(false)

  // Get field options for investor fields
  const fieldOptions = field.investor_field_options || []
