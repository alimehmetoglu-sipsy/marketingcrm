    ...
    >
      ...
      >
        ...
        <SelectContent>
          ...
          {sections
            .filter((section: FormSection) => ['contact_information', 'lead_details'].includes(section.section_key))
...
function FormPreview({ sections, fields }: { sections: FormSection[]; fields: LeadField[] }) {
...
export function FormViewConfigurator({ initialSections, initialFields }: FormViewConfiguratorProps) {
